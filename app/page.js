...
// Dynamically import AnimatedTestimonials with SSR disabled
const AnimatedTestimonials = dynamic(() => import("@/components/ui/animated-testimonials").then(mod => mod.AnimatedTestimonials), {
	ssr: false, // Prevents server-side rendering
});

const WarpBackground = dynamic(() => import("../components/magicui/warp-background").then(mod => mod.WarpBackground), {
	ssr: false, // Prevents server-side rendering
});  

export default function Home() {
	// Transform testimonialsData to match AnimatedTestimonials structure
	const formattedTestimonials = testimonialsData.map((testimonial) => ({
		quote: testimonial.quote,
		name: testimonial.name,
		designation: testimonial.role, // role -> designation
		src: testimonial.image, // image -> src
	  }));
